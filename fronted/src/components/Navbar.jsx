...
<div className='group-hover:block hidden absolute dropdown-menu right-0 pt-4'>
  <div className='flex flex-col gap-2 w-36 py-3 px-5 bg-gray-800 text-pink-200 rounded'>
...
<p className='absolute -bottom-1 -right-1 bg-slate-700 text-pink-200  rounded-full text-[10px] px-1.5 py-0.5 font-semibold leading-none'>4</p>
</Link>
